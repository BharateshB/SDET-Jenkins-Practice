...
public class LeadsSearchAnnualRevenueUtilTest {
	@Test
	
	public void leadsSearchAnnualRevenueUtilTest() throws Throwable {
		...
		String Salutation = eLib.readDataFromExcel("leadsSearchSal", 1, 1);
		String ComparisonTerm = eLib.readDataFromExcel("leadsSearchSal", 1, 2);
		String ComparisonValue = eLib.readNumDataFromExcel("leadsSearchSal", 1, 3);
