...
public class LeadsSearchFaxUtil {
@Test
	public void leadsSearchFaxUtil() throws Throwable {
		...
		String Salutation = eLib.readDataFromExcel("leadsSearchFax", 1, 1);
		String ComparisonTerm = eLib.readDataFromExcel("leadsSearchFax", 1, 2);
		String ComparisonValue = eLib.readNumDataFromExcel("leadsSearchFax", 1, 3);
