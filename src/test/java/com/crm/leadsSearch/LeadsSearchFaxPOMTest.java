...
public class LeadsSearchFaxPOMTest extends WebDriverUtility{

	@Test
	public void leadsSearchFaxPOMTest() throws Throwable  {
			...
			String ExcelSalutation = ef.readDataFromExcel("leadsSearchFax", 1, 1);
			String ExcelSalutCompare = ef.readDataFromExcel("leadsSearchFax", 1, 2);
			String ExcelSalutValue = ef.readNumDataFromExcel("leadsSearchFax", 1, 3);
