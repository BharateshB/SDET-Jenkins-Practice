...
public class LeadsSearchLeadsSrcTestNGTest extends BaseClass {

	@Test
	public void leadsSearchLeadsSrcTestNGTest() throws Throwable {
		
		/* Read Entire Data*/
		
		//Read data from Excel File
		String ExcelSalutation = eLib.readDataFromExcel("leadsSearchLeadSrc", 1, 1);
		String ExcelSalutCompare = eLib.readDataFromExcel("leadsSearchLeadSrc", 1, 2);
		String ExcelSalutValue = eLib.readDataFromExcel("leadsSearchLeadSrc", 1, 3);
