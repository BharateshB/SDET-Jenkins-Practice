...
public class LeadsSearchLeadsNoTestNGTest extends BaseClass {

	@Test
	public void leadsSearchLeadsNoTestNGTest() throws Throwable {

		/* Read Entire Data*/
		//Read data from Excel File
		String ExcelSalutation = eLib.readDataFromExcel("leadsSearchLeadNo", 1, 1);
		String ExcelSalutCompare = eLib.readDataFromExcel("leadsSearchLeadNo", 1, 2);
		String ExcelSalutValue = eLib.readDataFromExcel("leadsSearchLeadNo", 1, 3);
