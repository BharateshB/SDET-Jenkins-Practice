...
public class LeadsSearchByAnnualRevenuePOMTest extends WebDriverUtility {

	@Test
	public void leadsSearchByAnnualRevenuePOMTest() throws Throwable {
		...
		String ExcelSalutation = ef.readDataFromExcel("leadsSearchSal", 1, 1);
		String ExcelSalutCompare = ef.readDataFromExcel("leadsSearchSal", 1, 2);
		//String ExcelSalutValue = ef.readNumDataFromExcel("leadsSearchSal", 1, 3);
		...
		lasp.leadsSearch(ExcelSalutation, ExcelSalutCompare, ExcelAnnRevenue);
