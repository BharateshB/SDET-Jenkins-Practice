...
public class LeadsSearchLeadsSrcPOMTest extends WebDriverUtility{

	@Test
	public void leadsSearchLeadsSrcPOMTest() throws Throwable {
		...
		String ExcelSalutation = ef.readDataFromExcel("leadsSearchLeadSrc", 1, 1);
		String ExcelSalutCompare = ef.readDataFromExcel("leadsSearchLeadSrc", 1, 2);
		String ExcelSalutValue = ef.readDataFromExcel("leadsSearchLeadSrc", 1, 3);
