...
public class CreateContactWithOrgLeadsSrcTest {

	@Test
	public void createContactWithOrgLeadsSrcTest() throws Throwable {
		...
		String contactName = eLib.readDataFromExcel("Contact", 7, 2)+"_"+jLib.getRandomNumber();;
		String excelOrgName = eLib.readDataFromExcel("Contact", 7, 3)+"_"+jLib.getRandomNumber();
		String excelleadsSource = eLib.readDataFromExcel("Contact", 7, 4);
		...
		//step2: launch the browser
		 ...
		 //s9:create a new contact and save
			...
			ccp.createContact(driver, contactName, excelOrgName, excelleadsSource);
