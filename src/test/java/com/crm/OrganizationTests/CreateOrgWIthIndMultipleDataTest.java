...
public class CreateOrgWIthIndMultipleDataTest {	
	...
	//Create Obj for all utilities
			...
			public void createOrgWIthIndMultipleDataTest(String orgName, String indTypes) throws Throwable {
			...
			cop.createOrg(randorgname, indTypes);
		...
		{
			Object[][] data = eLib.readmultipleDataFromExcel("OrgDPTestOIT",1);
			return data;
		}
